...
const OurStoryPage = () => {
  return (
    <Wrapper>
      <div className="bg-[url('/story.jpeg')] bg-cover bg-center h-[600px] w-full relative mb-20">
        <h1 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold">
          OUR STORY
        </h1>
      </div>
      {/* Info section */}
      <div className="container mx-auto flex flex-col gap-20 mb-10 px-20 ">
        <p className="tracking-widest">
          ...
          with it’s cocktail of herbs and spices and juices that leave a
        ...
        <p className="tracking-widest">
          ...
          happy to bring you delicious Ghanaian style home made food that truly
          brings you joy. For Ghanaians living in Texas, this affords you the
          opportunity to enjoy the meals you loved back home in the flavours you
          ...
          soup that is full of flavour to carry your fufu all the way. For
          non-Ghanaians who wish to swim in this same excitement, Nana’s Kitchen
          is your source for the sauce! Checkout{" "}
          <span className="font-bold"> our Masukor</span> Menu to place an order
        ...
        <p className="tracking-widest">
          ...
          borrows its name from the Ga name for pepper (Ga is a Ghanian tribe
          ...
          Though Shito is typically known to be that full flavoured black sauce
